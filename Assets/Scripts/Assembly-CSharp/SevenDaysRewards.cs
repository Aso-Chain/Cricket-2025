...
public class SevenDaysRewards : Singleton<SevenDaysRewards>
{
	...
	public void RVSelected()
	{
		...
		//Singleton<AdIntegrate>.instance.showRewardedVideo(7); //Pratik
	}
	...
	{
		if (Application.internetReachability != NetworkReachability.NotReachable && CONTROLLER.isGameDataSecure)
		{

...
public class GameModel : Singleton<GameModel>
{
	...
	public void ShowBattingScoreCard()
	{
		...
		if (CONTROLLER.PlayModeSelected != 6)
		{
			...
			{
				//Singleton<AdIntegrate>.instance.DisplayInterestialAd(); //Pratik
	...
	public void UpdateCurrentBall(int validBall, int canCountBall, int runsScored, int extraRun, int batsmanID, int isWicket, int wicketType, int bowlerID, int catcherID, int batsmanOut, bool isBoundary)
	{
		...
		if (CONTROLLER.PlayModeSelected != 6 && Application.internetReachability != NetworkReachability.NotReachable && Application.internetReachability != NetworkReachability.NotReachable)
		{
	...
	public void WicketBall(int validBall, int batsmanID, int wicketType, int bowlerID, int catcherID, int batsmanOut)
	{
		...
		if (Application.internetReachability != NetworkReachability.NotReachable && 
			!overStepBall && CONTROLLER.PlayModeSelected != 7
			/*&& Singleton<AdIntegrate>.instance.isRewardedVideoAvailable*/ //Pratik
			&& !groundControllerScript.UltraEdgeCutscenePlaying && rebowlStatus != 0 && CONTROLLER.BattingTeamIndex == CONTROLLER.myTeamIndex)
		{
	...
	{
		Debug.Log("Pratik out 1");
		if (rebowlStatus > 0)
		{
            Debug.Log("Pratik out Return");
            return;
        }
        Debug.Log("Pratik out 3");

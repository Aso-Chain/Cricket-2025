...
public class PauseGameScreen : Singleton<PauseGameScreen>
{
	...
	private void autoPlaySelected()
	{
		...
		if (Application.internetReachability != NetworkReachability.NotReachable *//*&& Singleton<AdIntegrate>.instance.isRewardedVideoAvailable*//*)
		{
		...
		{
			//Singleton<AdIntegrate>.instance.requestRewardedVideo(); //Pratik
		}*/
	}
	...
	public void RVAutoPlaySelected()
	{
		...
		//Singleton<AdIntegrate>.instance.showRewardedVideo(3); //Pratik
	}

...
public class SpinWheel : Singleton<SpinWheel>
{
	...
	public void DisplaySubPanelText()
	{
		...
		case 8:
		{
			...
			{
			case 3:
				num7 = Random.Range(5000000, 10010000); // Add 3 Zero by Pratik
				AnimationCoinFalling.AnimationTransition(2);
				break;
			case 8:
				num7 = Random.Range(10000000, 30010000);// Add 3 Zero by Pratik
                            AnimationCoinFalling.AnimationTransition(3);
				break;
			case 0:
				num7 = Random.Range(30000000, 60100000);// Add 4 Zero by Pratik

...
/*	public void OpenWorldCupModes()
	...
	public void WatchVideoForExtraSpin()
	{
		...
		//Singleton<AdIntegrate>.instance.showRewardedVideo(5);  //Pratik
	}
	...
	public void WatchVideoForExtraTicket()
	{
		...
		//Singleton<AdIntegrate>.instance.showRewardedVideo(4);  //Pratik
	}
	...
	private void PushNotiCal()
	{
		...
		{
			if (Application.internetReachability != NetworkReachability.NotReachable /*&& Singleton<Google_SignIn>.instance.googleAuthenticated == 1*/)
			{
				OpenAchievements();
			}
			else
